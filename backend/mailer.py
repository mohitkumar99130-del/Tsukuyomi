...
A security snapshot is attached.

This alert was generated by an owner-armed Tsukuyomi anti-theft web prototype.
...
"""
    ...
    if os.path.exists(photo_path):
        ...
        print(f"[mailer] Warning: photo not found at {photo_path}, sending without attachment.")
